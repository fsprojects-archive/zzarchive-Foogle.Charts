...
let referenceBinaries = [ "Foogle.Charts.dll" ]
// Web site location for the generated documentation
let website = "/Foogle.Charts"

let githubLink = "http://github.com/fsprojects/Foogle.Charts"

// Specify more information about your project
let info =
  [ "project-name", "Foogle Charts"
...
let buildReference () =
  ...
  MetadataFormat.Generate
    ( binaries, output @@ "reference", layoutRoots, 
      parameters = ("root", root)::info, libDirs = [ bin @@ "../lib" ],
